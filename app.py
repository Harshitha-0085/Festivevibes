...
# Page configuration
st.set_page_config(
    page_title="FestiveVibe - Celebrating Telugu Festivals",
    page_icon="🎉",
    layout="wide",
...
def get_festival_data():
    festivals = {
        "Sankranti": {
            "telugu_name": "సంక్రాంతి",
            "date": "January 14-15",
            "description": "Harvest festival marking the sun's transit into Capricorn",
            "telugu_description": "సూర్యుడు మకర రాశిలోకి ప్రవేశించే సమయంలో జరుపుకునే పంట పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Bhogi bonfire", "Sankranti kite flying", "Pongal preparation", "Cattle decoration"],
            "foods": ["Pongal", "Sakinalu", "Garelu", "Payasam"],
            "attire": ["Traditional silk sarees", "Dhoti and kurta", "Colorful turbans"],
            "dances": ["Kolattam", "Dappu dance", "Gobbi dance"],
            "events": ["Kite competitions", "Bull fights", "Cock fights", "Community feasts"]
        },
        "Bathukamma": {
            "telugu_name": "బతుకమ్మ",
            "date": "September-October",
            "description": "Flower festival celebrating womanhood and nature",
            "telugu_description": "స్త్రీత్వం మరియు ప్రకృతిని జరుపుకునే పుష్పోత్సవం",
            "regions": ["Telangana"],
            "rituals": ["Flower arrangement", "Circular dance", "Immersion in water"],
            "foods": ["Pulihora", "Sakinalu", "Garelu", "Sweet rice"],
            "attire": ["Traditional sarees", "Flower jewelry", "Colorful bangles"],
            "dances": ["Bathukamma dance", "Circular folk dance"],
            "events": ["Community gatherings", "Cultural programs", "Folk songs"]
        },
        "Bonalu": {
            "telugu_name": "బోనాలు",
            "date": "July-August",
            "description": "Annual festival honoring Goddess Mahakali",
            "telugu_description": "మహాకాళి దేవిని గౌరవించే వార్షిక పండుగ",
            "regions": ["Telangana"],
            "rituals": ["Offering bonam", "Processions", "Temple visits"],
            "foods": ["Bonam rice", "Curd rice", "Sweet offerings"],
            "attire": ["Traditional sarees", "Red and yellow colors"],
            "dances": ["Bonalu dance", "Folk dances"],
            "events": ["Temple processions", "Cultural performances"]
        },
        "Ugadi": {
            "telugu_name": "ఉగాది",
            "date": "March-April",
            "description": "Telugu New Year marking the beginning of spring",
            "telugu_description": "వసంత ఋతువు ప్రారంభమయ్యే తెలుగు నూతన సంవత్సరం",
            "regions": ["AP", "Telangana"],
            "rituals": ["Panchanga sravanam", "Oil bath", "Neem consumption"],
            "foods": ["Ugadi pachadi", "Pulihora", "Bobbatlu", "Payasam"],
            "attire": ["New clothes", "Traditional silk sarees", "Dhoti and kurta"],
            "dances": ["Classical dances", "Folk dances"],
            "events": ["Cultural programs", "Family gatherings", "Temple visits"]
        },
        "Dasara": {
            "telugu_name": "దసరా",
            "date": "September-October",
            "description": "Victory of good over evil, celebrated for 10 days",
            "telugu_description": "మంచి చెడుపై గెలుపును జరుపుకునే పది రోజుల పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Golu display", "Vijayadashami", "Ayudha puja"],
            "foods": ["Sundal varieties", "Pulihora", "Payasam", "Laddu"],
            "attire": ["Traditional silk sarees", "Dhoti and kurta"],
            "dances": ["Classical dances", "Folk dances", "Dollu kunitha"],
            "events": ["Golu competitions", "Cultural programs", "Processions"]
        },
        "Deepavali": {
            "telugu_name": "దీపావళి",
            "date": "October-November",
            "description": "Festival of lights celebrating victory of light over darkness",
            "telugu_description": "చీకటిపై వెలుగు గెలుపును జరుపుకునే దీపాల పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Oil bath", "Lakshmi puja", "Fireworks"],
            "foods": ["Laddu", "Murukulu", "Garelu", "Payasam"],
            "attire": ["New clothes", "Traditional silk sarees"],
            "dances": ["Classical dances", "Folk dances"],
            "events": ["Family gatherings", "Fireworks display", "Temple visits"]
        },
        "Sri Rama Navami": {
            "telugu_name": "శ్రీ రామ నవమి",
            "date": "March-April",
            "description": "Birth celebration of Lord Rama",
            "telugu_description": "శ్రీరాముని జన్మదినం జరుపుకునే పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Rama puja", "Bhajan sessions", "Temple visits"],
            "foods": ["Panakam", "Neeru more", "Pulihora", "Payasam"],
            "attire": ["Traditional clothes", "White and yellow colors"],
            "dances": ["Classical dances", "Bhajan sessions"],
            "events": ["Temple celebrations", "Cultural programs", "Processions"]
        },
        "Varalakshmi Vratam": {
            "telugu_name": "వరలక్ష్మి వ్రతం",
            "date": "July-August",
            "description": "Vow to Goddess Lakshmi for prosperity and well-being",
            "telugu_description": "సంపద మరియు శుభకరమైన జీవితం కోసం లక్ష్మీ దేవికి చేసే వ్రతం",
            "regions": ["AP", "Telangana"],
            "rituals": ["Lakshmi puja", "Thread tying", "Fasting"],
            "foods": ["Pulihora", "Payasam", "Sweet rice", "Fruits"],
            "attire": ["Traditional silk sarees", "Gold jewelry"],
            "dances": ["Classical dances", "Devotional songs"],
            "events": ["Temple visits", "Community gatherings", "Cultural programs"]
        },
        "Ganesh Chaturthi": {
            "telugu_name": "వినాయక చవితి",
            "date": "August-September",
            "description": "Birth celebration of Lord Ganesha",
            "telugu_description": "వినాయకుని జన్మదినం జరుపుకునే పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Ganesha puja", "Modak offering", "Immersion"],
            "foods": ["Modak", "Laddu", "Pulihora", "Payasam"],
            "attire": ["Traditional clothes", "Red and yellow colors"],
            "dances": ["Classical dances", "Folk dances"],
            "events": ["Ganesha processions", "Cultural programs", "Immersion ceremonies"]
        },
        "Holi": {
            "telugu_name": "హోళీ",
            "date": "February-March",
            "description": "Festival of colors celebrating spring and love",
            "telugu_description": "వసంతం మరియు ప్రేమను జరుపుకునే రంగుల పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Color throwing", "Bonfire", "Community celebrations"],
            "foods": ["Gujiya", "Thandai", "Sweets", "Snacks"],
            "attire": ["White clothes", "Colorful accessories"],
            "dances": ["Folk dances", "Community dances"],
            "events": ["Color celebrations", "Community gatherings", "Cultural programs"]
        },
        "Karthika Deepam": {
            "telugu_name": "కార్తిక దీపం",
            "date": "November-December",
            "description": "Festival of lights during Karthika month",
            "telugu_description": "కార్తిక మాసంలో జరుపుకునే దీపాల పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Lighting lamps", "Temple visits", "Prayers"],
            "foods": ["Pulihora", "Payasam", "Sweet rice", "Fruits"],
            "attire": ["Traditional clothes", "White and yellow colors"],
            "dances": ["Classical dances", "Devotional songs"],
            "events": ["Temple celebrations", "Cultural programs", "Light displays"]
        },
        "Hanuman Jayanti": {
            "telugu_name": "హనుమాన్ జయంతి",
            "date": "March-April",
            "description": "Birth celebration of Lord Hanuman",
            "telugu_description": "హనుమానుని జన్మదినం జరుపుకునే పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Hanuman puja", "Bhajan sessions", "Temple visits"],
            "foods": ["Panakam", "Neeru more", "Pulihora", "Sweets"],
            "attire": ["Traditional clothes", "Orange and red colors"],
            "dances": ["Classical dances", "Bhajan sessions"],
            "events": ["Temple celebrations", "Cultural programs", "Processions"]
        },
        "Krishnashtami": {
            "telugu_name": "కృష్ణాష్టమి",
            "date": "August-September",
            "description": "Birth celebration of Lord Krishna",
            "telugu_description": "శ్రీకృష్ణుని జన్మదినం జరుపుకునే పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Krishna puja", "Dahi handi", "Bhajan sessions"],
            "foods": ["Makhan", "Laddu", "Pulihora", "Payasam"],
            "attire": ["Traditional clothes", "Yellow and blue colors"],
            "dances": ["Classical dances", "Folk dances", "Dahi handi"],
            "events": ["Dahi handi celebrations", "Cultural programs", "Temple visits"]
        },
        "Eid": {
            "telugu_name": "ఈద్",
            "date": "Varies (Islamic calendar)",
            "description": "Islamic festival celebrated by Muslim communities",
            "telugu_description": "ముస్లిం సమాజాలచే జరుపుకునే ఇస్లామిక్ పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Eid prayers", "Charity", "Family gatherings"],
            "foods": ["Biryani", "Sheer khurma", "Haleem", "Sweets"],
            "attire": ["Traditional Islamic clothes", "White and colorful dresses"],
            "dances": ["Cultural dances", "Community celebrations"],
            "events": ["Eid prayers", "Family gatherings", "Community feasts"]
        },
        "Christmas": {
            "telugu_name": "క్రిస్మస్",
            "date": "December 25",
            "description": "Christian festival celebrating birth of Jesus Christ",
            "telugu_description": "యేసు క్రీస్తు జన్మదినం జరుపుకునే క్రైస్తవ పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Christmas mass", "Prayers", "Gift giving"],
            "foods": ["Christmas cake", "Biryani", "Sweets", "Traditional dishes"],
            "attire": ["Traditional clothes", "Red and green colors"],
            "dances": ["Cultural dances", "Community celebrations"],
            "events": ["Christmas mass", "Family gatherings", "Community celebrations"]
        },
        "Kanuma": {
            "telugu_name": "కనుమ",
            "date": "January (day after Sankranti)",
            "description": "Festival dedicated to cattle, celebrated after Sankranti",
            "telugu_description": "సంక్రాంతి తర్వాత జరుపుకునే పశువుల పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Cattle worship", "Decorating cattle", "Feeding cattle special food"],
            "foods": ["Non-veg dishes", "Pulusu", "Rice items"],
            "attire": ["Traditional clothes"],
            "dances": ["Folk dances"],
            "events": ["Village gatherings", "Cattle fairs"]
        },
        "Nagula Chavithi": {
            "telugu_name": "నాగుల చవితి",
            "date": "October-November",
            "description": "Festival for worshipping serpent deities",
            "telugu_description": "పాములను పూజించే పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Snake idol worship", "Offering milk to anthills"],
            "foods": ["Fruits", "Payasam", "Rice dishes"],
            "attire": ["Traditional clothes"],
            "dances": ["Folk songs"],
            "events": ["Family gatherings", "Temple visits"]
        },
        "Poleramma Jathara": {
            "telugu_name": "పోలేరమ్మ జాతర",
            "date": "Varies (local calendar)",
            "description": "Local village festival dedicated to Goddess Poleramma",
            "telugu_description": "పోలేరమ్మ దేవికి జరిపే గ్రామోత్సవం",
            "regions": ["AP", "Telangana"],
            "rituals": ["Poleramma puja", "Processions", "Animal sacrifices (in some places)"],
            "foods": ["Prasadam", "Rice dishes"],
            "attire": ["Traditional clothes"],
            "dances": ["Folk dances", "Dappu"],
            "events": ["Village fair", "Cultural programs"]
        },
        "Raksha Bandhan": {
            "telugu_name": "రాఖీ పౌర్ణమి",
            "date": "August",
            "description": "Festival celebrating the bond between brothers and sisters",
            "telugu_description": "అక్కచెల్లెళ్ళు మరియు అన్నదమ్ముల బంధాన్ని జరుపుకునే పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Tying rakhi", "Gift exchange", "Family gatherings"],
            "foods": ["Sweets", "Rice dishes"],
            "attire": ["Traditional clothes"],
            "dances": ["Family songs"],
            "events": ["Family celebrations"]
        },
        "Sankatahara Chaturthi": {
            "telugu_name": "సంకటహర చతుర్థి",
            "date": "Every lunar month",
            "description": "Monthly festival dedicated to Lord Ganesha for removing obstacles",
            "telugu_description": "వినాయకునికి అంకితమైన నెలవారీ సంకటహర చతుర్థి పూజ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Ganesha puja", "Fasting", "Moon sighting"],
            "foods": ["Modak", "Fruits"],
            "attire": ["Traditional clothes"],
            "dances": ["Devotional songs"],
            "events": ["Temple visits", "Family prayers"]
        },
        "Maha Shivaratri": {
            "telugu_name": "మహా శివరాత్రి",
            "date": "February-March",
            "description": "Night dedicated to Lord Shiva with fasting and night-long vigil",
            "telugu_description": "లొర్డ్ శివుడికి అంకితమైన ఉపవాసం మరియు జాగరణతో కూడిన రాత్రి",
            "regions": ["AP", "Telangana"],
            "rituals": ["Shiva abhishekam", "Night vigil", "Fasting", "Chanting Om Namah Shivaya"],
            "foods": ["Fruits", "Milk", "Prasadam"],
            "attire": ["Traditional clothes", "White attire"],
            "dances": ["Bhajans", "Classical dances"],
            "events": ["Temple gatherings", "Processions"]
        },
        "Subrahmanya Shashti": {
            "telugu_name": "సుబ్రహ్మణ్య షష్టి",
            "date": "November-December",
            "description": "Festival dedicated to Lord Subrahmanya (Kartikeya)",
            "telugu_description": "కార్తికేయ స్వామికి అంకితమైన పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Subrahmanya puja", "Fasting", "Special prayers"],
            "foods": ["Fruits", "Rice dishes"],
            "attire": ["Traditional clothes"],
            "dances": ["Devotional songs"],
            "events": ["Temple visits", "Community prayers"]
        },
        "Ratha Saptami": {
            "telugu_name": "రథ సప్తమి",
            "date": "January-February",
            "description": "Festival dedicated to Sun God, marks the change of season",
            "telugu_description": "సూర్య భగవానునికి అంకితమైన పండుగ, ఋతువుల మార్పును సూచిస్తుంది",
            "regions": ["AP", "Telangana"],
            "rituals": ["Sun worship", "Holy bath", "Offering arghya"],
            "foods": ["Sweet pongal", "Rice dishes"],
            "attire": ["Traditional clothes"],
            "dances": ["Folk dances"],
            "events": ["Temple celebrations"]
        },
        "Varuna Yagam": {
            "telugu_name": "వరుణ యాగం",
            "date": "Varies (before monsoon)",
            "description": "Ritual for rain and prosperity dedicated to Lord Varuna",
            "telugu_description": "వర్షాలు, సంపద కోసం వరుణ దేవునికి చేసే యాగం",
            "regions": ["AP", "Telangana"],
            "rituals": ["Varuna puja", "Fire ritual", "Chanting mantras"],
            "foods": ["Prasadam", "Fruits"],
            "attire": ["Traditional clothes"],
            "dances": ["Folk dances"],
            "events": ["Community gatherings"]
        },
        "Chaitra Pournami": {
            "telugu_name": "చైత్ర పౌర్ణమి",
            "date": "March-April",
            "description": "Full moon festival in the month of Chaitra",
            "telugu_description": "చైత్ర మాసంలో వచ్చే పౌర్ణమి పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Full moon worship", "Temple visits"],
            "foods": ["Sweets", "Rice dishes"],
            "attire": ["Traditional clothes"],
            "dances": ["Folk dances"],
        ...
        "Vinayaka Nimajjanam": {
            "telugu_name": "వినాయక నిమజ్జనం",
            "date": "August-September",
            "description": "Immersion of Ganesha idols marking the end of Ganesh Chaturthi",
            "telugu_description": "వినాయక చవితి ముగిసిన తర్వాత వినాయక విగ్రహాల నిమజ్జనం",
            "regions": ["AP", "Telangana"],
            "rituals": ["Procession", "Immersion of idols", "Chanting"],
            "foods": ["Prasadam", "Sweets"],
            "attire": ["Traditional clothes"],
            "dances": ["Folk dances", "Dappu"],
            "events": ["Large processions", "Community celebrations"]
        },
        "Sri Krishna Tulasi Kalyanam": {
            "telugu_name": "శ్రీకృష్ణ తులసి కళ్యాణం",
            "date": "November-December",
            "description": "Symbolic wedding of Lord Krishna and Tulasi plant",
            "telugu_description": "శ్రీకృష్ణుడు మరియు తులసి మొక్క కళ్యాణం",
            "regions": ["AP", "Telangana"],
            "rituals": ["Tulasi puja", "Wedding rituals", "Chanting"],
            "foods": ["Prasadam", "Sweets"],
            "attire": ["Traditional clothes"],
            "dances": ["Devotional songs"],
            "events": ["Temple celebrations"]
        ...
        "Mukkoti Ekadashi": {
            "telugu_name": "ముక్కోటి ఏకాదశి",
            "date": "December-January",
            "description": "Important Ekadashi for Vaishnavites, observed with fasting",
            "telugu_description": "వైష్ణవులకు ముఖ్యమైన ఏకాదశి ఉపవాసం",
            "regions": ["AP", "Telangana"],
            "rituals": ["Fasting", "Vishnu puja", "Temple visits"],
            "foods": ["Fruits", "Prasadam"],
            "attire": ["Traditional clothes"],
            "dances": ["Devotional songs"],
            "events": ["Temple gatherings"]
        },
        "Bhogi": {
            "telugu_name": "భోగి",
            "date": "January (day before Sankranti)",
            "description": "First day of Sankranti, celebrated with bonfires and discarding old things",
            "telugu_description": "సంక్రాంతి మొదటి రోజు, పాత వస్తువులను తగలబెట్టి కొత్తదాన్ని ఆహ్వానించే పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Bhogi mantalu (bonfire)", "Cleaning homes", "Singing songs"],
            "foods": ["Rice dishes", "Sweets"],
            "attire": ["Traditional clothes"],
            "dances": ["Folk songs"],
            "events": ["Community bonfires"]
        },
        "Sri Venkateswara Brahmotsavam": {
            "telugu_name": "శ్రీ వెంకటేశ్వర బ్రహ్మోత్సవం",
            "date": "September-October",
            "description": "Grand annual festival at Tirumala Venkateswara Temple",
            "telugu_description": "తిరుమలలో జరిగే శ్రీ వెంకటేశ్వర స్వామి బ్రహ్మోత్సవం",
            "regions": ["AP"],
            "rituals": ["Processions", "Special pujas", "Chariot festival"],
            "foods": ["Prasadam", "Rice dishes"],
            "attire": ["Traditional clothes"],
            "dances": ["Classical dances", "Devotional songs"],
            "events": ["Temple processions", "Cultural programs"]
        },
        "Atla Taddi": {
            "telugu_name": "అట్ల తద్దె",
            "date": "October-November",
            "description": "Festival for married women, celebrated with special rituals and eating atlu (dosas)",
            "telugu_description": "పెళ్లయిన మహిళలు ఉపవాసం ఉండి అట్లను తినే పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Fasting", "Moon sighting", "Eating atlu (dosas)", "Pooja"],
            "foods": ["Atlu (dosas)", "Sweets"],
            "attire": ["Traditional sarees", "Jewelry"],
            "dances": ["Folk songs"],
            "events": ["Women gatherings"]
        },
        "Sankranti Kanuma Panduga": {
            "telugu_name": "కనుమ పండుగ",
            "date": "January (after Sankranti)",
            "description": "Cattle festival, part of Sankranti celebrations",
            "telugu_description": "సంక్రాంతి తర్వాత జరుపుకునే పశువుల పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Cattle worship", "Feeding cattle", "Village gatherings"],
            "foods": ["Non-veg dishes", "Rice items"],
            "attire": ["Traditional clothes"],
            "dances": ["Folk dances"],
            "events": ["Cattle fairs", "Village celebrations"]
        },
        "Pedda Panduga": {
            "telugu_name": "పెద్ద పండుగ",
            "date": "Varies (regional)",
            "description": "Major festival in many Andhra villages, celebrated with feasts and rituals",
            "telugu_description": "ఆంధ్ర గ్రామాల్లో జరుపుకునే ముఖ్యమైన పండుగ",
            "regions": ["AP"],
            "rituals": ["Village deity worship", "Community feasts"],
            "foods": ["Rice dishes", "Sweets", "Non-veg items"],
            "attire": ["Traditional clothes"],
            "dances": ["Folk dances"],
            "events": ["Village gatherings", "Cultural programs"]
        },
        "Sri Rama Pattabhishekam": {
            "telugu_name": "శ్రీరామ పట్టాభిషేకం",
            "date": "March-April",
            "description": "Coronation of Lord Rama, celebrated after Sri Rama Navami",
            "telugu_description": "శ్రీరాముని పట్టాభిషేకాన్ని జరుపుకునే పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Rama puja", "Reciting Ramayana", "Cultural programs"],
            "foods": ["Panakam", "Sweets"],
            "attire": ["Traditional clothes"],
            "dances": ["Classical dances", "Bhajans"],
            "events": ["Temple celebrations"]
        },
        "Laksha Deepotsavam": {
            "telugu_name": "లక్ష దీపోత్సవం",
            "date": "November-December",
            "description": "Festival of lighting one lakh lamps in temples and homes",
            "telugu_description": "పదివేల దీపాలను వెలిగించే పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Lighting lamps", "Temple worship"],
            "foods": ["Prasadam", "Sweets"],
            "attire": ["Traditional clothes"],
            "dances": ["Devotional songs"],
            "events": ["Temple gatherings"]
        ...
        "Sammakka Saralamma Jatara": {
            "telugu_name": "సమ్మక్క సారలమ్మ జాతర",
            "date": "February (biennial)",
            "description": "Asia's largest tribal festival held in Medaram, Telangana",
            "telugu_description": "తెలంగాణలోని మెదరం గ్రామంలో జరిగే ఆసియా అతిపెద్ద గిరిజన పండుగ",
            "regions": ["Telangana"],
            "rituals": ["Goddess worship", "Offerings", "Processions"],
            "foods": ["Rice dishes", "Sweets"],
            "attire": ["Traditional clothes", "Tribal attire"],
            "dances": ["Tribal dances", "Folk songs"],
            "events": ["Mass gatherings", "Cultural programs"]
        },
        "Toli Ekadashi": {
            "telugu_name": "తొలి ఏకాదశి",
            "date": "June-July",
            "description": "First Ekadashi of Ashada month, considered highly auspicious",
            "telugu_description": "ఆషాఢ మాసంలో వచ్చే తొలి ఏకాదశి",
            "regions": ["AP", "Telangana"],
            "rituals": ["Fasting", "Vishnu puja", "Temple visits"],
            "foods": ["Fruits", "Prasadam"],
            "attire": ["Traditional clothes"],
        ...
        "Ayyappa Deeksha/Makaravilakku": {
            "telugu_name": "అయ్యప్ప దీక్ష/మకరవిళక్కు",
            "date": "December-January",
            "description": "Pilgrimage and festival for Lord Ayyappa, culminating in Makaravilakku",
            "telugu_description": "అయ్యప్ప స్వామికి అంకితమైన దీక్ష మరియు మకరవిళక్కు పండుగ",
            "regions": ["AP", "Telangana"],
            "rituals": ["Ayyappa deeksha", "Pilgrimage", "Special pujas"],
            "foods": ["Simple vegetarian food", "Prasadam"],
            "attire": ["Black clothes", "Mala"],
            "dances": ["Bhajans"],
            "events": ["Pilgrim gatherings"]
        },
        "Ugadi Pachadi Day": {
            "telugu_name": "ఉగాది పచ్చడి రోజు",
            "date": "March-April (Ugadi)",
            "description": "Special day for preparing and sharing Ugadi Pachadi, symbolizing life's flavors",
            "telugu_description": "ఉగాది పచ్చడిని తయారు చేసి పంచుకునే ప్రత్యేక రోజు",
            "regions": ["AP", "Telangana"],
            "rituals": ["Preparing Ugadi pachadi", "Family gatherings"],
            "foods": ["Ugadi pachadi", "Sweets"],
            "attire": ["Traditional clothes"],
            "dances": ["Folk songs"],
            "events": ["Family celebrations"]
        },
        "Kondapalli Jathara": {
            "telugu_name": "కొండపల్లి జాతర",
            "date": "Varies (regional)",
            "description": "Local fair and festival in Kondapalli, Krishna district",
            "telugu_description": "కృష్ణా జిల్లాలోని కొండపల్లిలో జరిగే జాతర",
            "regions": ["AP"],
            "rituals": ["Village deity worship", "Processions"],
            "foods": ["Rice dishes", "Sweets"],
            "attire": ["Traditional clothes"],
            "dances": ["Folk dances"],
            "events": ["Village fair", "Cultural programs"]
...
def language_toggle():
    ...
    with col1:
        if st.button("🇮🇳 తెలుగు", key="telugu_btn"):
...
# Festival Details
def show_festival_details(festival_name, festival_data):
    st.markdown(f"""
    <div class="festival-details">
        <h2>{festival_data.get('telugu_name', festival_name) if st.session_state.language == 'telugu' else festival_name}</h2>
        <p><strong>📅 {festival_data['date']}</strong></p>
        <p>{festival_data.get('telugu_description', festival_data['description']) if st.session_state.language == 'telugu' else festival_data['description']}</p>
    </div>
    """, unsafe_allow_html=True)
...
def show_submit_form():
    if st.session_state.language == "telugu":
        st.title("📝 మీ సంప్రదాయాన్ని సమర్పించండి")
        st.markdown("మీ స్థానిక పండుగ సంప్రదాయాలను మాతో పంచుకోండి")
    else:
        st.title("📝 Submit Your Tradition")
        st.markdown("Share your local festival traditions with us")
...
def show_footer():
    st.markdown("""
    <div class="footer">
        <h3>FestiveVibe - Celebrating Telugu Festivals</h3>
        <p>Connect with us and share your traditions</p>
        <div style="margin: 1rem 0;">
            <a href="https://linkedin.com/in/your-profile" target="_blank" class="social-icon">🔗</a>
            <span class="social-icon">📧 contact@festivevibe.com</span>
            <span class="social-icon">📱 WhatsApp</span>
            <span class="social-icon">📸 Instagram</span>
        </div>
        <p style="margin-top: 2rem; font-size: 0.9rem;">
            © 2024 FestiveVibe. All rights reserved. | 
            Celebrating the rich cultural heritage of Andhra Pradesh and Telangana
        </p>
    </div>
    """, unsafe_allow_html=True)
...
def show_reminders():
    if st.session_state.language == "telugu":
        st.title("⏰ పండుగ రిమైండర్లు")
        st.markdown("మీకు ముఖ్యమైన పండుగలకు రిమైండర్లు సెట్ చేయండి")
    else:
        st.title("⏰ Festival Reminders")
        st.markdown("Set reminders for important festivals")
...
def show_gallery():
    if st.session_state.language == "telugu":
        st.title("📸 ఫోటో గ్యాలరీ")
        st.markdown("పండుగల ఫోటోలను చూడండి మరియు మీ ఫోటోలను పంచుకోండి")
    else:
        st.title("📸 Photo Gallery")
        st.markdown("View festival photos and share yours")
...
def show_quiz():
    if st.session_state.language == "telugu":
        st.title("🧠 పండుగ క్విజ్")
        st.markdown("మీ తెలుగు పండుగల జ్ఞానాన్ని పరీక్షించండి")
    else:
        st.title("🧠 Festival Quiz")
        st.markdown("Test your knowledge of Telugu festivals")
...
def show_map():
    if st.session_state.language == "telugu":
        st.title("🗺️ పండుగల మ్యాప్")
        st.markdown("ఆంధ్రప్రదేశ్ మరియు తెలంగాణలో పండుగల పంపిణీ")
    else:
        st.title("🗺️ Map of Celebrations")
        st.markdown("Distribution of festivals across Andhra Pradesh and Telangana")
...
def show_stories():
    if st.session_state.language == "telugu":
        st.title("📖 పండుగ కథలు")
        st.markdown("పండుగల గురించి కథలు, కవితలు మరియు అనుభవాలను పంచుకోండి")
    else:
        st.title("📖 Festival Stories")
        st.markdown("Share stories, poems, and experiences about festivals")
...
def show_posters():
    if st.session_state.language == "telugu":
        st.title("🖼️ పండుగ పోస్టర్లు")
        st.markdown("పండుగల పోస్టర్లు మరియు గ్రీటింగ్ కార్డ్లను డౌన్లోడ్ చేయండి")
    else:
        st.title("🖼️ Festival Posters")
        st.markdown("Download festival posters and greeting cards")
...
def show_admin_panel():
    if st.session_state.language == "telugu":
        st.title("⚙️ అడ్మిన్ ప్యానెల్")
        st.markdown("వెబ్సైట్ నిర్వహణ మరియు సంప్రదాయాలను నిర్వహించండి")
    else:
        st.title("⚙️ Admin Panel")
        st.markdown("Manage website and traditions")
